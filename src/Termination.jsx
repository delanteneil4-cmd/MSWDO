...
import { getAssignedCategories, getCategoryDisplayName, getStaffInfo, logActivity } from './utils/approvalWorkflow';
...
const Termination = () => {
  ...
  const changeStatus = async (member) => {
    ...
    const reason = window.prompt(`Enter the reason to ${action} ${member.firstName || ''} ${member.lastName || ''}:`);
